  ...
  return (
    <div className="w-full flex sm:flex-row flex-col sm:px-8 px-2 justify-center">
      ...
      {platformCardsData.map((platform, i) => (
        <div
          key={i}
          className="sm:h-[55vh] h-fit sm:w-2/6 w-6/6  hover:shadow-md hover:shadow-violet-800 transition-shadow duration-200 ease-in-out  bg-[#0F0922] bg-opacity-40 flex flex-col sm:mx-5 mx-2 rounded-xl text-white items-start justify-between sm:p-10 p-3 group sm:my-0 my-3"
        >
